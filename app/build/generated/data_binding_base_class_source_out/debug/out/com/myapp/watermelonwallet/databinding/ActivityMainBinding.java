...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull RelativeLayout rootView, @NonNull Button btnLogin,
      @NonNull EditText editPassword, @NonNull EditText editUsername, @NonNull ImageView logo,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((RelativeLayout) rootView, btnLogin, editPassword,
          editUsername, logo, textView2);
    }
